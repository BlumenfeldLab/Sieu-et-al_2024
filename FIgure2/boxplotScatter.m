function boxplotScatter(data, Title, yaxe, withlines, sumstats, errstats)
...
elseif strcmp(sumstats, 'average')
    ...
    nsize = sum(~isnan(data),1);
    errorbar([1:length(varNames)],mean(data,'omitnan'),std(data,'omitnan')./sqrt(nsize),...
