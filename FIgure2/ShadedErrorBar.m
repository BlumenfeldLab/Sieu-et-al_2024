...
% Taken from raacampbell/shadedE?rrorBar https://www.mathworks.com/matlabcentral/fileexchange/26311-raacampbell-shadederrorbar
% by Rob Campbell
% small change made to fix our legend
...
%               image. 
%
% legendTxt   - text for legend
% orderUse    - is this the first time the function is used in this
%               plot(1=yes)
% Outputs
...
% if orderUse
% hLegend=legend(legendTxt,'AutoUpdate','off', 'Location', 'eastoutside');
% else
%     hLegendNew.PlotChildren(end + 1) = legendTxt;
% end
